...
optimizer = dict(constructor='TimmConstructor',type='Adan', lr=0.0020, weight_decay=0.02)
...
checkpoint_path = r"F:\pumpkinCode\mmseg\pretrain_checkpoint\CMID_ResNet50_bk_200ep"
model = dict(
    type='EncoderDecoder',
