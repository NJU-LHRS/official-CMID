# model settings
checkpoint_file = r"F:\pumpkinCode\mmseg\pretrain_checkpoint\swin_millionaid_200ep"
...
optimizer = dict(constructor='TimmConstructor',type='Adan', lr=0.0003, weight_decay=0.02, filter_bias_and_bn=False,
		paramwise_cfg=dict(
  		      custom_keys={
