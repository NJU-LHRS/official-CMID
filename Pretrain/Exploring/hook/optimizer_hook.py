    ...
    def after_iter(self):
        ...
        if self.grad_clip is not None:
            ...
            if grad_norm is not None:
                ...
                self.trainer.log(self.trainer.cur_iter, smooth=False, grad_norm=grad_norm.detach().cpu().item())
...
class GradientCumulativeOptimizerHook(OptimizerHook):
    ...
    def after_iter(self):
        ...
        if (self.every_n_iters(self.cumulative_iters)
    ...
    def after_iter(self):
        ...
        if (self.every_n_iters(self.cumulative_iters)
            ...
            if self.grad_clip is not None:
                ...
                if grad_norm is not None:
                    # Add grad norm to the logger
                    self.trainer.log(self.trainer.cur_iter, grad_norm=grad_norm.detach().cpu().item())
